...
with st.expander("【セトリ対応済み公演】"):
    st.markdown(
        "トライアル公演、阿津賀志山異聞、幕末天狼傳、in厳島神社、"
        "真剣乱舞祭2016、三百年の子守唄、加州清光単騎2017、"
        "つわものどもがゆめのあと、真剣乱舞祭2017、結びの音始まりの音、"
        "阿津賀志山異聞2018巴里、真剣乱舞祭2018、三百年の子守唄2019、"
        "髭切膝丸双騎出陣2019、葵咲本紀、歌合乱舞狂乱2019、"
        "静かの海のパライソ、五周年記念壽乱舞音曲祭、東京心覚、"
        "江水散花雪、真剣乱舞祭2022、参騎出陣、祝玖寿乱舞音曲祭 ほか"
    )
