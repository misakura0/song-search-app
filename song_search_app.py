...
st.markdown("検索したい**曲名**や**刀剣男士の名前**を入力すると、それに一致したものが下の表に、")
st.markdown("複数結果が出てきた場合は表の左側の番号を選ぶと、詳細情報のところにそれぞれ表示されます。")
st.markdown("また、データを再読み込みのボタンを押すと表が最新状態になります。")
