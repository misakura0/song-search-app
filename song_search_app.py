...
st.markdown("""
ミュージカル刀剣乱舞の2部と祭り公演の曲名、歌唱者、見れるところを簡単に調べられるサイトです。　　
検索したい**曲名**や**刀剣男士の名前**を入力すると、それに一致したものが下の表に表示されます。 
例:加州は悲劇誰と歌ったことあるっけ？⇒曲名　美しい悲劇、歌唱者　加州で検索　　
　 鶴丸と豊前が一緒に歌った曲あるかな？⇒歌唱者　鶴丸 豊前で検索　など　　
複数結果が出てきた場合は表の左側の番号を選ぶと、詳細情報が表示されます。  
""")
